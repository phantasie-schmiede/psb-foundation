...
class FlexFormService
{
    ...
    /**
     * @param string $name
     * @param string $type Use constant \PSB\PsbFoundation\Services\Configuration\Fields::FIELD_TYPES for this argument
     * @param string $sheet
     * @param array  $customConfig
     * @param array  $customFieldConfiguration
     *
     * @return array
     * @see \PSB\PsbFoundation\Services\Configuration\Fields
     */
