...
class TypoScriptUtilityTest extends UnitTestCase
{
    ...
    {
        if (true === Environment::getContext()->isDevelopment()) {
            $expectedResult = '// TypoScript generated by PSB\PsbFoundation\Utility\TypoScript\TypoScriptUtilityTest:convertArrayToTypoScript in line 42' . LF . $expectedResult;
        }
